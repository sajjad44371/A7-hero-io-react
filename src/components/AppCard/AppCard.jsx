...
const AppCard = ({ app }) => {
  ...
  return (
    <Link to={`/details/${app.id}`}>
      <div className="rounded-md bg-white shadow-sm hover:shadow-lg hover:scale-105 transition ease-in-out duration-300">
        <div className="p-4">
          <img
            src={app.image}
            alt=""
            className="w-full h-[300px] lg:h-[250px] rounded-md"
          />
